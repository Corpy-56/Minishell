...
#    Updated: 2025/08/05 16:51:19 by skuor            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_FILES = main.c ft_tokenisation.c environ.c utils.c variables.c
BLTINS_FILES = ft_exit.c ft_pwd.c ft_env.c ft_echo.c ft_cd.c ft_unset.c
