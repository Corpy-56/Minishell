...
#    Updated: 2025/09/12 13:34:23 by skuor            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_FILES = main.c ft_tokenisation.c variables.c environ.c expansion.c ft_type_token.c external_cmd.c
BLTINS_FILES = ft_exit.c ft_pwd.c ft_env.c ft_echo.c ft_cd.c ft_unset.c ft_export.c
UTILS_FILES = utils.c utils_var.c utils_expan.c utils_token.c free.c ft_type_token_utils.c
